...
endpoints = {
    ...
    "resources": "https://data-vortex-api.onrender.com/round1/earth_resources",
...
endpoints_round2 = {
    "planets": "https://data-vortex-api.onrender.com/round2/planets",
    "resources": "https://data-vortex-api.onrender.com/round2/resources",
    "climate": "https://data-vortex-api.onrender.com/round2/climate",
    "soil": "https://data-vortex-api.onrender.com/round2/soil",
    "biosphere": "https://data-vortex-api.onrender.com/round2/biosphere",
    "energy_sources": "https://data-vortex-api.onrender.com/round2/energy_sources"
}

dfs_round2 = {}
for name, url in endpoints_round2.items():
    try:
        response = requests.get(url)
        response.raise_for_status()
        data = response.json()
        ...
        dfs_round2[name] = pd.DataFrame()

# Unify data
unified_planets_df = dfs_round2["planets"].copy()
for name, df in dfs_round2.items():
    if name != "planets":
...
# Save CSVs
unified_planets_df.to_csv(r"D:\SRM EXTRA\\earth_unified_clean.csv", index=False)
print("\nSaved Round 2 data as 'planets_round2_unified.csv'")

if not results_df.empty:
    ranked_df.to_csv(r"D:\SRM EXTRA\\earth_unified_clean.csv", index=False)
